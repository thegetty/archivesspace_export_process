...
aes_path_SC = "/home/jovyan/archivesspace_export_service/exporter_app/workspace/ead/exported/ead/"
aes_path_IA = "/home/jovyan/archivesspace_export_service_IA/exporter_app/workspace/ead/exported/ead/"
staging_path = "/home/jovyan/ead_processing/staging/"
primo_path = "/home/jovyan/ead_processing/readyforprimo/"
final_path = "/home/jovyan/ead_processing/readyforpub/"
oac_path = "/home/jovyan/ead_processing/readyforoac/"
logpath = "/home/jovyan/ead_processing/"
...
logname  = os.path.dirname(logpath) + filename
...
s3_buckets = ['jpgt-or-stg-rcv', 'jpgt-or-prd-rcv']
	...
	for k, v in updated_filenames.items():
		...
		try:
			if publication == 'completed' and filedate.date() > last_week:
				shutil.copy(old_xml_with_dest, staging_with_dest_xml )
				shutil.copy(old_xml_with_dest, rcv_with_dest_xml )
				shutil.copy(old_pdf_with_dest, rcv_with_dest_pdf )
				try:
...
with open('new_records.csv', 'w', newline="\n") as new_rec_file:
